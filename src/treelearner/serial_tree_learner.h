#ifndef LIGHTGBDT_TREELEARNER_SERIAL_TREE_LEARNER_H_
#define LIGHTGBDT_TREELEARNER_SERIAL_TREE_LEARNER_H_

#include <LightGBDT/utils/random.h>
#include <LightGBDT/utils/array_args.h>
...
#endif   // LightGBDT_TREELEARNER_SERIAL_TREE_LEARNER_H_