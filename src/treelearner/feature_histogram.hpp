#ifndef LIGHTGBDT_TREELEARNER_FEATURE_HISTOGRAM_HPP_
#define LIGHTGBDT_TREELEARNER_FEATURE_HISTOGRAM_HPP_
...
#endif   // LightGBDT_TREELEARNER_FEATURE_HISTOGRAM_HPP_