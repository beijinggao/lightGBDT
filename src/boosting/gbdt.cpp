...
#include <LightGBDT/objective_function.h>
...
std::string GBDT::ModelToIfElse(int num_iteration) const {
  ...
  str_buf << "#include <LightGBDT/utils/openmp_wrapper.h>" << std::endl;
  str_buf << "#include <LightGBDT/utils/common.h>" << std::endl;
  str_buf << "#include <LightGBDT/objective_function.h>" << std::endl;
  str_buf << "#include <LightGBDT/metric.h>" << std::endl;
  ...
  str_buf << "namespace LightGBDT {" << std::endl;
