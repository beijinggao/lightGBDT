#ifndef LIGHTGBDT_METRIC_H_
#define LIGHTGBDT_METRIC_H_
...
public:
  ...
  */
  LIGHTGBDT_EXPORT static Metric* CreateMetric(const std::string& type, const MetricConfig& config);
