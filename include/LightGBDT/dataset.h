#ifndef LIGHTGBDT_DATASET_H_
#define LIGHTGBDT_DATASET_H_

#include <LightGBDT/utils/random.h>
#include <LightGBDT/utils/text_reader.h>
#include <LightGBDT/utils/openmp_wrapper.h>

#include <LightGBDT/meta.h>
#include <LightGBDT/config.h>
#include <LightGBDT/feature_group.h>
...
public:
  ...
  LIGHTGBDT_EXPORT Dataset();

  LIGHTGBDT_EXPORT Dataset(data_size_t num_data);
  ...
  LIGHTGBDT_EXPORT bool CheckAlign(const Dataset& other) const {
  ...
  LIGHTGBDT_EXPORT void FinishLoad();

  LIGHTGBDT_EXPORT bool SetFloatField(const char* field_name, const float* field_data, data_size_t num_element);

  LIGHTGBDT_EXPORT bool SetDoubleField(const char* field_name, const double* field_data, data_size_t num_element);

  LIGHTGBDT_EXPORT bool SetIntField(const char* field_name, const int* field_data, data_size_t num_element);

  LIGHTGBDT_EXPORT bool GetFloatField(const char* field_name, data_size_t* out_len, const float** out_ptr);

  LIGHTGBDT_EXPORT bool GetDoubleField(const char* field_name, data_size_t* out_len, const double** out_ptr);

  LIGHTGBDT_EXPORT bool GetIntField(const char* field_name, data_size_t* out_len, const int** out_ptr);

  /*!
  * \brief Save current dataset into binary file, will save to "filename.bin"
  */
  LIGHTGBDT_EXPORT void SaveBinaryFile(const char* bin_filename);

  LIGHTGBDT_EXPORT void CopyFeatureMapperFrom(const Dataset* dataset);

  LIGHTGBDT_EXPORT void CreateValid(const Dataset* dataset);
