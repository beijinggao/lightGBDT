#ifndef LIGHTGBDT_APPLICATION_H_
#define LIGHTGBDT_APPLICATION_H_
...
/*!
* \brief The main entrance of LightGBDT. this application has two tasks:
*        Train and Predict.
...
#endif   // LightGBDT_APPLICATION_H_