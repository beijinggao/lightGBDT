#ifndef LIGHTGBDT_UTILS_TEXT_READER_H_
#define LIGHTGBDT_UTILS_TEXT_READER_H_

#include <LightGBDT/utils/pipeline_reader.h>
...
#endif   // LightGBDT_UTILS_TEXT_READER_H_
